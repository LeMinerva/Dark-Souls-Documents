function parseXML(){
  ...
  for(var i=0;i<71;i++){
    ...
    document.write("<div class=\"icon\"><img src=\"icons\/magic1\/"+[i]+".png\"><\/div>");
    document.write("<div class=\"chn\">");
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/chn1/magic_name.xml");
    }else{
      xmlhttp.open("get","text/chn1/magic_name.xml",false);
      xmlhttp.send(null);
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/chn1/magic_desc.xml"); 
    }else{
      xmlhttp.open("get","text/chn1/magic_desc.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/chn1/magic_remk.xml");
    }else{
      xmlhttp.open("get","text/chn1/magic_remk.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/jap1/magic_name.xml");
    }else{
      xmlhttp.open("get","text/jap1/magic_name.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/jap1/magic_desc.xml"); 
    }else{
      xmlhttp.open("get","text/jap1/magic_desc.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/jap1/magic_remk.xml");
    }else{
      xmlhttp.open("get","text/jap1/magic_remk.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/eng1/magic_name.xml");
    }else{
      xmlhttp.open("get","text/eng1/magic_name.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/eng1/magic_desc.xml"); 
    }else{
      xmlhttp.open("get","text/eng1/magic_desc.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/eng1/magic_remk.xml");
    }else{
      xmlhttp.open("get","text/eng1/magic_remk.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
