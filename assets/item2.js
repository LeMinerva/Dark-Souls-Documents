function parseXML(){
  ...
  for(var i=0;i<226;i++){
    ...
    document.write("<div class=\"icon\"><img src=\"icons\/item2\/"+[i]+".png\"><\/div>");
    document.write("<div class=\"chn\">");
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/chn2/item_name.xml");
    }else{
      xmlhttp.open("get","text/chn2/item_name.xml",false);
      xmlhttp.send(null);
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/chn2/item_desc.xml"); 
    }else{
      xmlhttp.open("get","text/chn2/item_desc.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/chn2/item_remk.xml");
    }else{
      xmlhttp.open("get","text/chn2/item_remk.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/jap2/item_name.xml");
    }else{
      xmlhttp.open("get","text/jap2/item_name.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/jap2/item_desc.xml"); 
    }else{
      xmlhttp.open("get","text/jap2/item_desc.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/jap2/item_remk.xml");
    }else{
      xmlhttp.open("get","text/jap2/item_remk.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/eng2/item_name.xml");
    }else{
      xmlhttp.open("get","text/eng2/item_name.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/eng2/item_desc.xml"); 
    }else{
      xmlhttp.open("get","text/eng2/item_desc.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
    ...
    if(navigator.userAgent.indexOf("Chrome")==-1){
      xmlDoc.load("text/eng2/item_remk.xml");
    }else{
      xmlhttp.open("get","text/eng2/item_remk.xml",false);
      xmlhttp.send(null);
      xmlDoc=xmlhttp.responseXML.documentElement;
    }
